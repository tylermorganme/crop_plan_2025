#!/usr/bin/env node
/**
 * Build varieties-template.json from extracted Excel data.
 *
 * Reads: tmp/varieties_from_excel.json
 * Writes: src/data/varieties-template.json
 *
...
const outputPath = path.join(__dirname, 'varieties-template.json');
